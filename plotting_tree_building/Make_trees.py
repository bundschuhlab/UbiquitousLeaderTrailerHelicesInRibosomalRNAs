...
tree_fldr = "new-results/trees_" + rRNA_type + "/"
...
phyla_of_interest = ["proteobacteria", "firmicutes", "actinobacteriota", "bacteroidota"]
phyla_name_node_dict = {}
encountered_phyla = []
for root_phyla in phyla_of_interest:
    phyla_name_node_dict[root_phyla] = []
    for phyla in all_phyla:
        if root_phyla in phyla.lower():
            phyla_name_node_dict[root_phyla].append(phyla)
            encountered_phyla.append(phyla)
...
def make_trees(acc_signal_dict, phyla, phyla_tree_loc, acc_taxonomy_dict, add_rrna):
    ...
    with open(phyla_tree_loc + "tree-labels.txt", "w") as f:
        ...
        f.write("45.0_p__Firmicutes" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Firmicutes" + "\n")
        f.write("83.0_p__Firmicutes_A" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Firmicutes_A" + "\n")
        f.write("92.0_p__Firmicutes_B" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Firmicutes_B" + "\n")
        f.write("15.0_p__Firmicutes_C" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Firmicutes_C" + "\n")
        f.write("100.0_p__Firmicutes_F_ c__Halanaerobiia" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Firmicutes_F" + "\n")
        f.write("86.0_p__Campylobacterota" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Campylobacterota" + "\n")
        f.write("100.0_p__Cyanobacteria" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Cyanobacteria" + "\n")
        f.write("100.0_p__Fusobacteriota_ c__Fusobacteriia" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Fusobacteriota" + "\n")
        f.write("6.0_p__Desulfobacterota" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Desulfobacterota" + "\n")
        f.write("96.0_p__Spirochaetota" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Spirochaetota" + "\n")
        f.write("100.0_p__Planctomycetota" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Planctomycetota" + "\n")
        f.write("38.0_p__Myxococcota" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Myxococcota" + "\n")
        f.write("100.0_p__Deinococcota_ c__Deinococci" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Deinococcota" + "\n")
        f.write("6.0_p__Desulfobacterota" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Desulfobacterota" + "\n")
        f.write("100.0_p__Thermotogota_ c__Thermotogae" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Thermotogota" + "\n")
        f.write("99.0_p__Chloroflexota" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Chloroflexota" + "\n")
        f.write("100.0_p__Verrucomicrobiota" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Verrucomicrobiota" + "\n")
        f.write("100.0_p__Chlamydiota_ c__Chlamydiia" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Chlamydiota" + "\n")
        f.write("100.0_p__Acidobacteriota" + "\t" + "range" + "\t" + "#FFFFFF" + "\t" + "Acidobacteriota" + "\n")
