...
sys.path.append('/home/fung/meme/lib/meme-5.5.1/python')
...
def dinucleotide_shuffle(input_seq, seed, copies):
    alph = alphabet.dna()
    random.seed(seed)

    # Below is default file - rewrote to just pass it a sequence
    # and get back shuffled sequence(s)    
    shuffled_seqs = []
    for i in range(copies):
        shuffledSeq = dinuclShuffle(input_seq, alph)
        shuffled_seqs.append(shuffledSeq)
